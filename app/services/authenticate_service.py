...
def authentication(f):
    ...
    def decorated_function(*args, **kwargs):
        try:
            ...
            if not token:
                messages = [
                    "Hello! I'm currently only able to speak with Stephen.", "I'm still in build mode.",
                    "However, if you'd like to learn more about Stephen, I'd suggest checking him out on LinkedIn:",
                    "https://www.linkedin.com/in/stephen-keenan/",
                    "Or book a time to chat:",
                    "https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ02Ay5xQ5KRJgIT1TKOZy1wsRHvxLBejqYlRLGzlPUg5-Sbk7dcdZSVLZG77Jh8y6U3ySV4NYOE"
                ]

                # return redirect(url_for("main.home")) # redirect to the main home page.
            # =========== OLD RESPONSE ===========
                return jsonify({"response": messages}), 200  # Return 401 Unauthorized with HTML content
